...
def get_file_content_with_header(filepath):
    """
    Reads the content of the given file and returns it with a header indicating the file name.
    """
...
def main():
    ...
    if os.path.exists(main_file):
        prompt_parts.append(get_file_content_with_header(main_file))
    else:
    ...
    if os.path.isdir(tests_dir):
        for filename in sorted(os.listdir(tests_dir)):
            if filename.endswith(".py"):
                ...
                prompt_parts.append(get_file_content_with_header(file_path))
    else:
